...
func (md *MDOpsStandard) GetForHandle(ctx context.Context, handle *TlfHandle,
	mStatus MergeStatus) (tlf.TlfID, ImmutableRootMetadata, error) {
	mdserv := md.config.MDServer()
	bh, err := handle.ToBareHandle()
	if err != nil {
		return tlf.TlfID{}, ImmutableRootMetadata{}, err
	}
	...
	if rmds == nil {
		if mStatus == Unmerged {
			...
			// mStatus == Unmerged.
			return tlf.TlfID{}, ImmutableRootMetadata{}, nil
		}
...
func (md *MDOpsStandard) processMetadataWithID(ctx context.Context,
	id tlf.TlfID, bid BranchID, handle *TlfHandle, rmds *RootMetadataSigned,
...
func (md *MDOpsStandard) getForTLF(ctx context.Context, id tlf.TlfID,
...
func (md *MDOpsStandard) GetUnmergedForTLF(
	ctx context.Context, id tlf.TlfID, bid BranchID) (
	ImmutableRootMetadata, error) {
	return md.getForTLF(ctx, id, bid, Unmerged)
}

func (md *MDOpsStandard) processRange(ctx context.Context, id tlf.TlfID,
...
func (md *MDOpsStandard) getRange(ctx context.Context, id tlf.TlfID,
...
func (md *MDOpsStandard) GetUnmergedRange(ctx context.Context, id tlf.TlfID,
...
func (md *MDOpsStandard) GetLatestHandleForTLF(ctx context.Context, id tlf.TlfID) (
	BareTlfHandle, error) {
